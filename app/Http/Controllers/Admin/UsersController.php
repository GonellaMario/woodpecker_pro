...
class UsersController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            $table->addColumn('team_team_name', function ($row) {
                return $row->team ? $row->team->team_name : '';
            });

            $table->editColumn('resource_cost', function ($row) {
                return $row->resource_cost ? $row->resource_cost : '';
            });

            $table->rawColumns(['actions', 'placeholder', 'verified', 'two_factor', 'roles', 'team']);
    ...
    public function create()
    {
        ...
        $teams = Team::all()->pluck('team_name', 'id')->prepend(trans('global.pleaseSelect'), '');
    ...
    public function show(User $user)
    {
        ...
        $user->load('roles', 'team', 'userDailyActivities');
